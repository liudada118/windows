...
17. [非功能性需求](#17-非功能性需求)
18. [补充 S1-S5：多租户隔离、算料引擎、下料优化、软删除、审计日志](#18-补充-s1-s5多租户隔离算料引擎下料优化软删除审计日志)
19. [补充 S6-S9：订单变更、退款退货、安装管理、售后服务](#19-补充-s6-s9订单变更退款退货安装管理售后服务)
20. [补充 S10-S13：AI 炫图、阳光房 3D、AR 拍照搭配、设备对接](#20-补充-s10-s13ai-炫图阳光房-3dar-拍照搭配设备对接)
21. [补充 S14-S16：数据模型修正、状态机协同、通知系统](#21-补充-s14-s16数据模型修正状态机协同通知系统)
22. [补充 S17-S19：API 规范、UX 设计规格、非功能性需求增强](#22-补充-s17-s19api-规范ux-设计规格非功能性需求增强)
...
| 4.0 | 2026-03-02 | Manus AI | **深度补齐版。** 修复 36 项缺失：新增租户表和数据隔离方案；定义算料公式引擎 DSL 语法和执行流程；定义下料优化算法需求；补全订单变更/退款/安装/售后四大业务流程；详细定义 AI 炫图/阳光房 3D/AR 拍照搭配/设备对接四大模块；修正数据模型不一致；新增通知系统；补全 API 规范和 UX 设计规格 |
...
## 18. 补充 S1-S5：多租户隔离、算料引擎、下料优化、软删除、审计日志

> 本章节覆盖 P0 级缺失项（P0-01 至 P0-08）及 P1-11、P1-12。

详见独立文档：[supplements/P0_数据隔离与核心算法.md](supplements/P0_数据隔离与核心算法.md)

---

## 19. 补充 S6-S9：订单变更、退款退货、安装管理、售后服务

> 本章节覆盖 P1 级缺失项（P1-01 至 P1-04）。

详见独立文档：[supplements/P1_业务流程补全.md](supplements/P1_业务流程补全.md)

---

## 20. 补充 S10-S13：AI 炫图、阳光房 3D、AR 拍照搭配、设备对接

> 本章节覆盖 P1 级缺失项（P1-05 至 P1-08）。

详见独立文档：[supplements/P1_空洞模块定义.md](supplements/P1_空洞模块定义.md)

---

## 21. 补充 S14-S16：数据模型修正、状态机协同、通知系统

> 本章节覆盖 P1 级缺失项（P1-09、P1-10、P1-13）。

详见独立文档：[supplements/P1_数据模型修正.md](supplements/P1_数据模型修正.md)

---

## 22. 补充 S17-S19：API 规范、UX 设计规格、非功能性需求增强

> 本章节覆盖 P2 级缺失项（P2-01 至 P2-15）。

详见独立文档：[supplements/P2_品质与体验提升.md](supplements/P2_品质与体验提升.md)
